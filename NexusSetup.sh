...
#Step-1: Copy the lines from 4 to 21, and then paste it on your terminal. All the commands will be executed one by one.
#Step-2: Manually you need to update the file /etc/init.d/nexus with NEXUS HOME as instructed in line number 22-25.
#Step-3: Copy the lines from 27 to 38, and then paste it on your terminal. All the commands will be executed one by one.
